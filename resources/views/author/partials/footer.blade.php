			...
			<div class="row">
				<div class="col-md-12 mb-md-5 ftco-animate">
					<div class="ftco-footer-widget">
						<h1 class="logo">BD Marriage Media</h1>
						<p class="text-justify form-label">
							bdmarriagemedia.com, Matchmaking Service, was founded with a simple objective - to help people find happiness. bdmarriagemedia.com is a social networking site specialising in matchmaking and not just a matrimonial service. As a leader in what is sometimes known as the matrimony category. bdmarriagemedia.com has always differentiated itself from other matrimonials through its innovation-led approach. By redefining the way Bangladeshi brides and grooms meet for marriage, bdmarriagemedia.com has created a world-renowned brand that has changed the way of finding a life partner. <a href="{{ route('about_us') }}" class="text-light">Learn more<span class="ico_arrow"></span></a>
						</p>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-sm-3">
					...
					<ul class="footer_link">
						...
						<li><a href="" class="form-label">user Support</a></li>
				...
				<div class="col-sm-3">
					<h3>More</h3>
					<ul class="footer_link">
						<!-- <li><a href="" target="_blank" class="form-label">VIP bdmarriagemedia</a></li> -->
						<!-- <li><a href="" target="_blank" class="form-label">Select bdmarriagemedia</a></li> -->
						<!-- <li><a href="" target="_blank" class="form-label">bdmarriagemedia Centres</a></li> -->
...
<script>
    ...
    // userTokens = $.trim(localStorage.getItem("userToken"));
    loggedIns = $.trim(localStorage.getItem("userLoggedIn"));
    if (loggedIns != '1') {
        $(".auth-login").remove();
    } else {
    ...
    function logOut() {
		...
		$.ajax({
			...
			success: function(data) {
				...
				window.location.href = '/'; // or: "{{ route('index') }}" if inside Blade
			},

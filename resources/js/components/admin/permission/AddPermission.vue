                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <div class="modal-body">
                            ...
                            <div v-for="permissionChild in permissionChildren">
                                <div class="row border">
                                    <div class="col-md-5">
                                        <div>
                                    ...
                                    <div class="col-md-1">
                                        <button class="btn btn-sm btn-danger mt-2" @click="removeNewRow(permissionChild)"><i class="fa fa-times"></i></button>
                            ...
                            <div class="text-left mt-2">
                                <button type="submit" class="btn btn-primary btn-pill mr-center"
                                    @click="addPermission()"> <span v-if="edit == true">
...
export default {
    ...
    mounted() {
        ...
        console.log(this.permissionChildren)
    },
};
</script>

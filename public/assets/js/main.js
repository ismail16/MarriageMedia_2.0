...
$(function ($) {
  ...
  // if (sidebar.length != 0) {
    $(document).on("click",".sidebar .nav > .has-sub > a",function (e) {
      ...
      $('.sidebar .nav b').removeClass('fa-rotate-45');
      $(this).find('b').toggleClass('fa-rotate-45');

    })
    // $(document).on("click",".sidebar .nav > .has-sub > a",function (e) {
    //   $(this).parent().toggleClass('expand');
    //   $(this).find('b').toggleClass('fa-rotate-90');
  ...
  /*======== RIGHT SIDEBAR ========*/
  // $(document).on("click", ".right-sidebar-2-menu", function (e) {
  //   $(".tools-sidebar-overlay").toggleClass("d-block");
  //   $(".right-sidebar-container-2").toggleClass("right-sidebar-2-visible");
  ...
  // $(document).on("click", ".notify-toggler", function (e) {
  //   $(".dropdown-notify").toggleClass("d-block");
  // })
  $(document).on("click", function (e) {
      // Toggle dropdown when the toggle button is clicked
      if ($(e.target).closest(".notify-toggler").length) {
          $(".dropdown-notify").toggleClass("d-block");
      } 
      // Hide the dropdown when clicking outside of it
      else if (!$(e.target).closest(".dropdown-notify").length) {
          $(".dropdown-notify").removeClass("d-block");
      }
  });

  $(document).on("click", "#close_btn", function (e) {
    $('.right-sidebar-toggoler-out').removeClass('sidebar-mobile-in')
  })
